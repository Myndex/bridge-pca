...
a).toFixed(c);throw"Err-3";}function bridgeRatio(a,b,c,d,e){d=void 0===d?" to 1":d;e=void 0===e?1:e;b=Math.max(b,c);c=.16;.506<b&&(c=(1-b)/.494*.0815+.0785);a=Math.max(0,Math.abs(.01*parseFloat(void 0===a?0:a)));b=1.113946*(Math.pow(a+-.0561,4.537)+.2693)*a+c;b=.3<b?10*b:.06>a?0:10*b-(Math.pow(.3-b+.42,.48)-.6594);return b.toFixed(e)+d}
function sRGBtoY(a){a=void 0===a?[0,0,0]:a;return.212647813391364*Math.pow(a[0]/255,2.4)+.715179147533615*Math.pow(a[1]/255,2.4)+.0721730390750208*Math.pow(a[2]/255,2.4)}function displayP3toY(a){a=void 0===a?[0,0,0]:a;return.228982959480578*Math.pow(a[0]/255,2.4)+.691749262585238*Math.pow(a[1]/255,2.4)+.0792677779341829*Math.pow(a[2]/255,2.4)}
function adobeRGBtoY(a){a=void 0===a?[0,0,0]:a;return.297355022711381*Math.pow(a[0]/255,2.35)+.627372749714528*Math.pow(a[1]/255,2.35)+.0752722275740913*Math.pow(a[2]/255,2.35)}function alphaBlend(a,b,c){a=void 0===a?[0,0,0,1]:a;b=void 0===b?[0,0,0]:b;c=void 0===c?!0:c;if(a[3]){a[3]=Math.max(Math.min(a[3],1),0);var d=1-a[3],e=[0,0,0];for(i=0;3>i;i++)e[i]=b[i]*d+a[i]*a[3],c&&(e[i]=Math.min(Math.round(e[i]),255));return e}return a}
function calcBPCA(a,b,c,d){c=void 0===c?-1:c;d=void 0===d?!0:d;b=colorParsley(b);a=colorParsley(a);""!=a[3]&&1>a[3]&&(a=alphaBlend(a,b,d));return BPCAcontrast(sRGBtoY(a),sRGBtoY(b),c)}module.exports={BPCAcontrast:BPCAcontrast,bridgeRatio:bridgeRatio,sRGBtoY:sRGBtoY,displayP3toY:displayP3toY,adobeRGBtoY:adobeRGBtoY,alphaBlend:alphaBlend,calcBPCA:calcBPCA};
